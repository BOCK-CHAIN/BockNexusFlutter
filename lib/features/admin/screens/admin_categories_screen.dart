...
class AdminCategoriesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          await context.push('/admin/categories/new');
          ref.read(adminCategoriesProvider.notifier).refresh();
        },
  ...
  Widget _buildBody(BuildContext context, WidgetRef ref,
      AdminCategoriesState state, ThemeData theme) {
              ...
              trailing: Row(
                ...
                children: [
                  IconButton(
                    ...
                    onPressed: () async {
                      await context
                          .push('/admin/categories/${category.id}');
                      ref
          ...
          TextButton(
            onPressed: () async {
              ...
              if (context.mounted) {
                showAppSnackBar(
                  context,
                  ok ? 'Category deleted' : 'Failed to delete category',
                );
              }
            },
            child: Text('Delete',
